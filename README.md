...
![Tests](https://img.shields.io/badge/Tests-125_erfolgreich-2ea44f)
...
- **Tutorial Mission 2 – Dunkles Netz** mit angekündigtem Netzausfall und zwei geprüften Schutzstrategien
- **Mission 3 – Falsche Echos** mit Gelände, Interferenz und beobachtbaren Täuschindizien
- **Mission 4 – Sättigung** mit mobiler Reserve, wechselnden Angriffsachsen und Herausforderung
- Hauptmenü, datengetriebene Missionsauswahl, lokaler Kampagnenfortschritt und missionsspezifisches Debriefing
...
Die vollständige Suite importiert das Projekt headless und führt 125 deterministische Unit-, Integrations- und End-to-End-Testfälle aus:
...
- [Kampagnenfluss und Missionsrahmen](docs/kampagnenfluss.md)
