...
Prüfung vom 15. September 2026: Projektimport, Parserprüfung und alle 135 Testfälle mit Godot 4.7.2 bestanden. Sechs zusätzliche Regressionstests sichern Einstellungsdateien und deren Wiederherstellungsablauf ab. Die Hinweise wurden im laufenden macOS-Spiel bei 1280×720 visuell geprüft; die Debug-Exports für macOS, Windows und Linux wurden erfolgreich erzeugt. Diese Prüfung ersetzt keine nativen Windows-/Linux-Laufzeittests. Details und verbleibender Umfang von #18 stehen unter [Einstellungsdateien und Wiederherstellung](einstellungen-und-wiederherstellung.md).

Letzte Gesamtabnahme: 10. September 2026 mit Godot 4.7.2. Der Projekt-Smoke-Test und alle 129 Testfälle bestanden ohne Scriptfehler. Neben der vollständigen 180-Sekunden-Vertical-Slice-Mission wurde Tutorial Mission 1 vom Briefing über alle zehn Lernschritte bis zur Auswertung automatisiert durchgespielt. Hauptnavigation, Missionskatalog, strukturierte Briefings, Debriefing-Übergänge, Vier-Missionen-Freischaltkette, Profilfortschritt, Einstellungen, Netzgraph, Sichtbarkeitsmasken, mobile Systeme, Stör- und Täuschverläufe sowie die drei Zielauflösungen werden zusätzlich headless geprüft.
...
- Alle vier Kampagnenmissionen und das zusätzliche freie Testszenario sind spielbar. Zwei Strategien pro neuer Mission sowie die Herausforderung des Finales sind automatisiert geprüft. Externe Playtests stehen noch aus.
...
1. Tutorial Mission 2 für Netzabhängigkeiten und Priorisierung unter Zeitdruck.
2. Zusätzliche Missionskarten und Balancing der Geländezonen.
3. Missionsspezifisches Mobilitäts- und Stör-Balancing.
